...
describe("Answer Screen", () => {
  it.skip("should display the Answer tiltle", () => {
...
describe('AnswerComponent', () => {
  ...
  it('should call OnUpvote when the upvote arrow is clicked', () => {
  ...
  it('should call OnEditButtonClick when the edit button is clicked', () => {
  ...
  it('should not display "Marked helpful by author" when answerHelpful is false', () => {
    render(
      <AnswerArea
        answerText={answerText}
        votes={votes}
